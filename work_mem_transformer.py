...
# the vanilla Transformer implementation was adopted from https://www.tensorflow.org/text/tutorials/transformer
...
class Transformer(tf.keras.Model):
	def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size, 
								 target_vocab_size, pe_input, pe_target, rate=0.1, token_type=False):
	...
	def call(self, inp, tar, training, enc_padding_mask,
		...
		enc_output, enc_attn = self.encoder(inp, training, enc_padding_mask)
